                ...
                <div className="shadow p-4 mt-4">
                    ...
                    <form onSubmit={handleSubmit} id="create-conference-form">
                        ...
                        <div className="form-outline mb-3">
                            ...
                            <textarea onChange={handleDescriptionChange} value={description} placeholder="Description" required type ="text" name="description" id="textAreaExample1" className="form-control" rows="4"></textarea>
                        </div>
                        <div className="form-floating mb-3">
                            ...
                            <label htmlFor="max_presentations">Maximum presentaions</label>
                        </div>
                        <div className="form-floating mb-3">
